...
\tikzset{
  ...
  orthogonal projection/.code args={#1--#2}{
    ...
    \pgfkeysalso{cm={\pgf@tmpxx,\pgf@tmpxy,\pgf@tmpxy,\pgf@tmpyy,(\pgf@xa,\pgf@ya)},shift={(-\pgf@xa,-\pgf@ya)}}%
  },
  slanted projection/.code args={#1--#2//#3--#4}{
    ...
    \pgfkeysalso{cm={\pgf@tmpy*\pgf@sys@tonumber{\pgf@xa},\pgf@tmpy*\pgf@sys@tonumber{\pgf@ya},\pgf@tmpx*\pgf@sys@tonumber{\pgf@xa},\pgf@tmpx*\pgf@sys@tonumber{\pgf@ya},(\pgf@xb,\pgf@yb)},shift={(-\pgf@xb,-\pgf@yb)}}%
  },
  projection/.code={
    \parseprojection{#1}
  },
  ...
  slanted symmetry/.code args={#1--#2//#3--#4}{
    ...
    \pgfkeysalso{cm={\pgf@tmpy*\pgf@sys@tonumber{\pgf@xa}-1,\pgf@tmpy*\pgf@sys@tonumber{\pgf@ya},\pgf@tmpx*\pgf@sys@tonumber{\pgf@xa},\pgf@tmpx*\pgf@sys@tonumber{\pgf@ya}-1,(\pgf@xb,\pgf@yb)},shift={(-\pgf@xb,-\pgf@yb)}}%
  },
  symmetry/.code={
    \parsesymmetry{#1}
  },
  to base/.code args={#1--#2--#3}{
    ...
    % to base transform
    \pgfkeysalso{cm={\pgf@sys@tonumber{\pgf@xa},\pgf@sys@tonumber{\pgf@ya},\pgf@sys@tonumber{\pgf@xc},\pgf@sys@tonumber{\pgf@yc},(\pgf@xb,\pgf@yb)}}%
  },
